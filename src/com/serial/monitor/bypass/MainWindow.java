...
public class MainWindow {
	...
	private void initialize() {
		...
		serial2ComboBox.setBounds(219, 23, 91, 22);
		frame.getContentPane().add(serial2ComboBox);
		
		JComboBox<String> watcherComboBox = new JComboBox<String>(getSerialPorts());
		//JComboBox<String> bypassComboBox = new JComboBox<String>();
		watcherComboBox.setBounds(118, 60, 91, 22);
		...
		Connect.setBounds(118, 105, 97, 25);
